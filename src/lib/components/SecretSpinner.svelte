...
>
	<svg
		...
		class="spinner z-[50] mt-12 flex max-h-[50vh] max-w-[320px] opacity-80"
	>
		<path
	...
	<code
		class="unstyled rocker flex items-center whitespace-nowrap rounded bg-surface-50 px-2 py-0.5 font-mono text-lg font-bold dark:bg-[#28292a]"
		>Loading...</code
	>
</div>
