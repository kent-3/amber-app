...
<div
	class="absolute inset-0 flex flex-col gap-2 items-center justify-center overflow-clip backdrop-blur-sm pointer-events-none"
...
>
	<svg
		...
		class="spinner z-[50] flex mt-12 max-w-[320px] max-h-[50vh] opacity-80"
	>
		<path
			...
			fill="none"
			class="dark:stroke-primary-500 stroke-secondary-600"
			stroke-width="2.0122"
	...
	<code
		class="unstyled rocker py-0.5 px-2 flex items-center rounded text-lg font-mono font-bold whitespace-nowrap bg-surface-50 dark:bg-[#28292a]"
		>Loading...</code
	>
</div>
