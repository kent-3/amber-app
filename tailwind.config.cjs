	...
	theme: {
		extend: {
			backgroundImage: {
				...
				'spotlights-light':"radial-gradient(circle at 20% 120%, hsla(37,86%,61%,0.36) 0px, transparent 50%),radial-gradient(circle at 76% -20%, hsla(218,13%,53%,0.47) 0px, transparent 50%);",
